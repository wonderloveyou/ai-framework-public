...
| Aspect | Value |
|--------|-------|
| **Input** | Topic, feature area, or constraint to generate ideas about |
| **Output** | Ranked ideation artifact in docs/ideation/ with evaluation criteria |
| **Side effects** | Creates doc in docs/ideation/. No code changes. |
| **Guard** | Do not plan or implement. Generate and evaluate ideas only. |

## Anti-Rationalization

| Excuse | Reality |
|--------|---------|
| "I already have an idea, let me just build it" | First idea = most obvious idea. Generate 5+ alternatives before committing. |
| "Ideation is a waste of time" | Wrong direction costs days. 10 minutes of ideation prevents weeks of wrong work. |
| "The user will tell me if my idea is bad" | Users describe problems, not solutions. Your job is to surprise them with better options. |
